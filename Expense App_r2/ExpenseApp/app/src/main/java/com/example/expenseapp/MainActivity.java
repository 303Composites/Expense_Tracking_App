...
public class MainActivity extends AppCompatActivity {
    ...
    //user input array
    ArrayList<String> expense_id, expense_type, expense_date, expense_amount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customAdapter = new CustomAdapter(MainActivity.this,expense_id,expense_type,expense_date,expense_amount);
